...
import BmPolylineNew from './overlays/PolylineNew.vue'
...
import BmlMarkerClustererNew from './extra/MarkerClustererNew.vue'
import BmlDrawingManager from './extra/DrawingManager.vue'
...
export default {
  install (Vue, options) {
    ...
    Vue.component('bm-polyline', BmPolylineNew)
...
export {
  ...
  BmMarker, BmPointCollection, BmPolyline, BmPolylineNew, BmPolygon, BmCircle, BmGround, BmLabel, BmInfoWindow, BmOverlay,
