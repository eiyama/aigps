...
// 新添加的
export function createMarker (BMap, options) {
  const { lng, lat, offset, icon, massClear, dragging, clicking, raiseOnDrag, draggingCursor, rotation, shadow, title } = options
  return new BMap.Marker(createPoint(BMap, { lng, lat }), {
    offset,
