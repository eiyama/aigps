 ...
 * 涓诲叆鍙ｇ被鏄�<a href="symbols/BMapLib2.DrawingManager.html">DrawingManager</a>锛�
...
/** 
 * @namespace BMap鐨勬墍鏈塴ibrary绫诲潎鏀惧湪BMapLib2鍛藉悕绌洪棿涓�
 */
var BMapLib2 = BMapLib2 || {};
/**
 * 瀹氫箟甯搁噺, 缁樺埗鐨勬ā寮�
...
(function() {
    ...
    /** 
     * @exports DrawingManager as BMapLib2.DrawingManager 
     */
    var DrawingManager =
        /**
         ...
         * var myDrawingManagerObject = new BMapLib2.DrawingManager(map, {isOpen: true, 
         ...
         *     });
         */
        BMapLib2.DrawingManager = function(map, opts){
            if (!map) {
                return;
            }
            instances.push(this);
    ...
    DrawingManager.prototype._calculate = function (overlay, point) {
        ...
        if (this._enableCalculate && BMapLib2.GeoUtils) {
            var type = overlay.toString();
            //涓嶅悓瑕嗙洊鐗╄皟鐢ㄤ笉鍚岀殑璁＄畻鏂规硶
            switch (type) {
                case "[object Polyline]":
                    result.data = BMapLib2.GeoUtils.getPolylineDistance(overlay);
                    break;
                case "[object Polygon]":
                    result.data = BMapLib2.GeoUtils.getPolygonArea(overlay);
                    break;
                case "[object Circle]":
    ...
    Mask.prototype._bind = function() {
        ...
        var domEvent = function(e) {
            var type = e.type;
                e = baidu.getEvent(e);
            var point = me.getDrawPoint(e); //褰撳墠榧犳爣鎵€鍦ㄧ偣鐨勫湴鐞嗗潗鏍�
