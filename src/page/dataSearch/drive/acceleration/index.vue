...
export default {
  ...
  data() {
    const searchList = getCopyObj(this.$t('acceleration.searchList'));
    const tableTitle = this.$t('acceleration.tableTitle');
    return {
      searchList,
      tableTitle,
      tableData: [],
  ...
  methods: {
    ...
    exportFile() {
      ...
      if (length) {
        exportFile(length, this.$t('acceleration.curTitle'));
      } else {
