<template>
	<popup-view
		...
		:title="title"
		:isZoom="false"
		:css="{ minWidth: '400px', width: 'auto', height: 'auto' }"
	>
		<div class="content">
			<div class="img">
				<img v-if="info.driveImage" :src="info.driveImage" />
				<p v-else>暂无图片</p>
			</div>
			<div class="ul">
...
export default {
	...
	created() {
		const arr = this.$t('allMonitor.contactInfo')
		this.i18nArr = arr.slice(0, 2)
  },
  beforeDestroy() {
    this.i18nArr = []
    this.info = {}
